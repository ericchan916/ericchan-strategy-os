...
const ASK_MODE_SYSTEM_PROMPT_FALLBACK =
  ...
  + "[V0.6.7 短回答约束] 普通 Ask 总长度控制在 260-420 中文字以内，最多 4 个小段，最多 5 个 bullet，必须先给结论再给理由/下一步，只保留判断/理由/下一步三类信息。联网 Ask 总长度 400-600 中文字，只列最关键的 3 条外部信息，不逐条长篇复述来源。项目体检与项目开工包按各自骨架展开不受此约束。fallback 也按普通 Ask 短约束输出。";
